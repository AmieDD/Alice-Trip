...
var makeSpiral = function( revolutions, radiusIn, radiusOut) {
    ...
    for (angle = 0; angle < turns + step; angle += step) {
      ...
      //Add the noise to the radius
      //Math.abs returns the absolute value of a number
        radius *= 1 + Math.abs(n0 + n1) * 0.06;
